...
class SubmitForm extends Component {
  ...
  chosenBeer = () =>
    this.state.isCustomBeer ? this.state.customBeer : this.state.beer;
  ...
  submit = e => {
    ...
    if (this.isValid()) {
      localStorage.setItem(
        "happy-hour-saved-state",
        JSON.stringify(omit(["isLoading"], this.state))
      );
      const formData = {
  ...
  renderForm() {
    const beers = this.props.beerStore.sortedBeers;
      ...
      <StyledForm onSubmit={this.submit}>
        ...
        <FormGroup row={true}>
          <TextField
            ...
            disabled={isLoading}
            classes={
              this.state.isCustomBeer
                ? { root: this.props.classes.greyedOut }
                : { root: this.props.classes.common }
            }
